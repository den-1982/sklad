...
base.updateControls();base.response();base.moveEvents();base.stopOnHover();base.owlStatus();if(base.options.transitionStyle!==false)base.transitionTypes(base.options.transitionStyle);if(base.options.autoPlay===true)base.options.autoPlay=base.options.autoPlayInterval;base.play();base.$elem.find(".owl-wrapper").css("display","block");if(!base.$elem.is(":visible"))base.watchVisibility();else base.$elem.css("opacity",1);base.onstartup=false;base.eachMoveUpdate();if(typeof base.options.afterInit==="function")base.options.afterInit.apply(this,
...
"owlCarousel",carousel)})};$.fn.owlCarousel.options={items:5,itemsCustom:false,itemsDesktop:[1199,4],itemsDesktopSmall:[979,3],itemsTablet:[768,2],itemsTabletSmall:false,itemsMobile:[600,1],singleItem:false,itemsScaleUp:false,slideSpeed:200,paginationSpeed:600,rewindSpeed:1E3,autoPlay:false,autoPlayInterval:5E3,stopOnHover:true,navigation:true,navigationText:["",""],rewindNav:true,scrollPerPage:false,pagination:true,paginationNumbers:false,responsive:true,responsiveRefreshRate:200,responsiveBaseWidth:window,
