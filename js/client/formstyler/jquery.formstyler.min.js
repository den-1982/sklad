...
selectSearchPlaceholder:"\u041f\u043e\u0438\u0441\u043a...",selectVisibleOptions:0,singleSelectzIndex:"100",selectSmartPositioning:!0,onSelectOpened:function(){},onSelectClosed:function(){},onFormStyled:function(){}},z);return this.each(function(){function C(){var c="",v="",b="",m="";void 0!==a.attr("id")&&""!==a.attr("id")&&(c=' id="'+a.attr("id")+d.idSuffix+'"');void 0!==a.attr("title")&&""!==a.attr("title")&&(v=' title="'+a.attr("title")+'"');void 0!==a.attr("class")&&""!==a.attr("class")&&(b=
" "+a.attr("class"));var e=a.data(),g;for(g in e)""!==e[g]&&(m+=" data-"+g+'="'+e[g]+'"');this.id=c+m;this.title=v;this.classes=b}var a=c(this),F=navigator.userAgent.match(/(iPad|iPhone|iPod)/i)&&!navigator.userAgent.match(/(Windows\sPhone)/i)?!0:!1,z=navigator.userAgent.match(/Android/i)&&!navigator.userAgent.match(/(Windows\sPhone)/i)?!0:!1;if(a.is(":checkbox"))a.each(function(){if(1>a.parent("div.jq-checkbox").length){var d=function(){var d=new C,b=c("<div"+d.id+' class="jq-checkbox'+d.classes+
...
function(){b.removeClass("focused")})};d();a.on("refresh",function(){a.off(".styler").parent().before(a).remove();d()})}});else if(a.is(":radio"))a.each(function(){if(1>a.parent("div.jq-radio").length){var u=function(){var v=new C,b=c("<div"+v.id+' class="jq-radio'+v.classes+'"'+v.title+'><div class="jq-radio__div"></div></div>');a.css({position:"absolute",zIndex:"-1",opacity:0,margin:0,padding:0}).after(b).prependTo(b);b.attr("unselectable","on").css({"-webkit-user-select":"none","-moz-user-select":"none",
...
new C,b=a.data("placeholder");void 0===b&&(b=d.filePlaceholder);var m=a.data("browse");if(void 0===m||""===m)m=d.fileBrowse;var e=c("<div"+v.id+' class="jq-file'+v.classes+'"'+v.title+' style="display: inline-block; position: relative; overflow: hidden"></div>'),g=c('<div class="jq-file__name">'+b+"</div>").appendTo(e);c('<div class="jq-file__browse">'+m+"</div>").appendTo(e);a.after(e);e.append(a);a.is(":disabled")&&e.addClass("disabled");a.on("change.styler",function(){var c=a.val();if(a.is("[multiple]"))for(var c=
...
new C,p="",n=a.data("placeholder"),h=a.data("search"),m=a.data("search-limit"),t=a.data("search-not-found"),q=a.data("search-placeholder"),y=a.data("z-index"),x=a.data("smart-positioning");void 0===n&&(n=d.selectPlaceholder);if(void 0===h||""===h)h=d.selectSearch;if(void 0===m||""===m)m=d.selectSearchLimit;if(void 0===t||""===t)t=d.selectSearchNotFound;void 0===q&&(q=d.selectSearchPlaceholder);if(void 0===y||""===y)y=d.singleSelectzIndex;if(void 0===x||""===x)x=d.selectSmartPositioning;var f=c("<div"+
...
q+'"></div><div class="jq-selectbox__not-found">'+t+"</div>");var k=c('<div class="jq-selectbox__dropdown" style="position: absolute">'+p+'<ul style="position: relative; list-style: none; overflow: auto; overflow-x: hidden">'+u+"</ul></div>");f.append(k);var r=c("ul",k),l=c("li",k),A=c("input",k),z=c("div.jq-selectbox__not-found",k).hide();l.length<m&&A.parent().hide();""===a.val()?w.text(n).addClass("placeholder"):w.text(e.text());var B=0;l.each(function(){var a=c(this);a.css({display:"inline-block"});
a.innerWidth()>B&&(B=a.innerWidth(),a.width());a.css({display:""})});p=f.clone().appendTo("body").width("auto");h=p.find("select").outerWidth();p.remove();h==f.width()&&w.width(B);B>f.width()&&k.width(B);w.is(".placeholder")&&w.width()>B&&w.width(w.width());""===g.first().text()&&""!==a.data("placeholder")&&l.first().hide();a.css({position:"absolute",left:0,top:0,width:"100%",height:"100%",opacity:0});var I=f.outerHeight(),D=A.outerHeight(),E=r.css("max-height"),p=l.filter(".selected");1>p.length&&
l.first().addClass("selected sel");void 0===l.data("li-height")&&l.data("li-height",l.outerHeight());var J=k.css("top");"auto"==k.css("left")&&k.css({left:0});"auto"==k.css("top")&&k.css({top:I});k.hide();p.length&&(g.first().text()!=e.text()&&f.addClass("changed"),f.data("jqfs-class",p.data("jqfs-class")),f.addClass(p.data("jqfs-class")));if(a.is(":disabled"))return f.addClass("disabled"),!1;H.click(function(){c("div.jq-selectbox").filter(".opened").length&&d.onSelectClosed.call(c("div.jq-selectbox").filter(".opened"));
a.focus();if(!F){var b=c(window),q=l.data("li-height"),e=f.offset().top,p=b.height()-I-(e-b.scrollTop()),h=a.data("visible-options");if(void 0===h||""===h)h=d.selectVisibleOptions;var n=5*q,m=q*h;0<h&&6>h&&(n=m);0===h&&(m="auto");var h=function(){k.height("auto").css({bottom:"auto",top:J});var a=function(){r.css("max-height",Math.floor((p-20-D)/q)*q)};a();r.css("max-height",m);"none"!=E&&r.css("max-height",E);p<k.outerHeight()+20&&a()},w=function(){k.height("auto").css({top:"auto",bottom:J});var a=
